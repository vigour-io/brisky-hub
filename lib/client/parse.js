'use strict'
var setwithpath = require('vigour-util/setwithpath') //replace /w lodash
var StringDecoder = require('string_decoder').StringDecoder
var decoder = new StringDecoder('utf8')
var isStream = require('vigour-util/is/stream')
// this will be removed soon! --- make a unified mofo for everything
// serilize for this too much special shit going on here!
...
function parse (data, observable, output, event) {
  if (isStream(data)) {
    ...
    if (data === null) {
      if (observable.parent && observable.parent._input === null) {
    ...
    if (observable && ((observable._input && observable._input._base_version) || event && observable.lastStamp === event.stamp)) {
      data = void 0
      output = void 0
    }
  }
