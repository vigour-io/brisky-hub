    ...
    send (observable, hub, data, event) {
      ...
      if (hub.instance) {
        if (this.instance && hub.instance === this.instance) {
          console.log('  update on instance and this client cares!', hub.instance)
          // or is part of the inheritance chain!
        } else {
          console.log('  update on instance and this client does NOT care!', hub.instance)
          return
        }
      }
      ...
      if (this.connection && data !== void 0 && this._input) {
        ...
        if (output !== void 0) {
          ...
          console.error('SEND!', output, observable._path)
