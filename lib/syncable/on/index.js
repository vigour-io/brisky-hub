    ...
    on (type, attach) {
      ...
      if (typeof type === 'string') {
        ...
        if (base._on && base._on[type] instanceof SubsEmitter) {
          ...
          let path = base._path
          path.pop()
          // resolve path for deeper stuff
          base.sendUpstream(void 0, event, { val: base._on[type].pattern.serialize(), path: path })
          ...
          base.sendUpstream(void 0, event, { val: attach[2][1].parent.serialize(), path: path })
