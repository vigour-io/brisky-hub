...
exports.define = {
  ...
  $: function (map) {
    ...
    // super small maps then use the subscibe thing yourself here... its prtty annoying but totally rdy for unififcation
    // as soon as its completely done -- then add upstreams and multiply the hubs
    // super important get into perf mobe again -- fix attach -- we need to use keys espically on the hub where there will be 1000s of subscriptions
