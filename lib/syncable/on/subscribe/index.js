...
exports.define = {
  $ (map, attach, ready) {
    // console.warn(JSON.stringify(map, false, 2))
    // add remove listener to attach!
    // if ! attach make it or something?
    // this gives zero information of course
    // only fix for now is the context
    if (attach) {
