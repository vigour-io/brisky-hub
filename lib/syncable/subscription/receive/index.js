...
exports.define = {
  subscriptionWalker: function subscriptionWalker (key, hub, map, event, result, client, top, path, hash) {
    ...
    // this means we have to send the map as well when removing or we have to search for the subs map stored somewhere prob smartes
