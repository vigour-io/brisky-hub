...
exports.define = {
  startTcpServer (port) {
    ...
    server.on('connection', function (socket) {
      var xlistener = incoming(adapter, socket)
      var listener = function(data) {
        // console.log('---->', data.toString(), socket.client && socket.client.val)
        return xlistener.call(this, data)
      }
      socket.send = function(msg) {
        // console.log('<----', msg, socket.client && socket.client.val)
        socket.write(msg)
      }
