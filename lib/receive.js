...
exports.define = {
  receive (data) {
    if (data.state) {
      ...
      // hub.incoming.force = {
      //   // so this should be forced but does not -- something wrong with root subs here
      //   // now whats up -- receiving -- needs to set forcefrom the ensted elements
      //   [hub.get('receiver', {}).sid()]: true
      // }
